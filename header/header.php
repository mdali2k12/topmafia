...
class headers {
    ...
    <head>
        ...
        <link href="https://topmafia.net/header/css/style.css" media='screen, projection' rel='stylesheet' type='text/css'>
    ...
    <body>
            <div class="mainpage2">
                <div class="usertopbar">
                    <table width="100%">
                        <tr>
                        <td width="20%" align="left"><?php echo"$u $d"; ?>                                         
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="logout.php">Logout</a>
                        ...
                        <td width="9%" align="left"><?php echo"Level {$ir['level']}"; ?><br />
                          <div class="exptext"><?php echo"".cash_format($ir['exp'])." / ".cash_format($ir['exp_needed']).""; ?></div></td>
                        <td width="41%" align="left">
                        <div class="emptyprogressbar">
                       
                                            <div class="expbarprogress" style="width:<?= $experc ?>%;height: 15px;"></div>
                                        </div> 
                                        </td>
      ...
      <img src="https://topmafia.net/header/images/imageicons/lightning-icon.png" style="display:inline-block;width:19px;margin-right:5px;"><div class="emptyprogressxbar" style="margin-top:5px;display:inline:block;">
                                        ...
                                        </div></div><?php echo"<small>".cash_format($ir['energy'])."</small> / <b>".cash_format($ir['maxenergy']).""; ?></b>
                               </td>
                                <td width="16%" class="tabstyle">
                                     <div class="iconbeside">
      <img src="https://topmafia.net/header/images/imageicons/steroidicon.png" style="display:inline-block;width:19px;margin-right:5px;"><div class="emptyprogressxbar" style="margin-top:5px;display:inline:block;">
                                        ...
                                        <?php echo"<small>".cash_format($ir['will'])."</small> / <b>".cash_format($ir['maxwill']).""; ?></b>
                               </td>
                               <td width="16%" class="tabstyle" align="left">
                                   
                                     <div class="iconbeside">
      <img src="https://topmafia.net/header/images/imageicons/gun-icon.png" style="display:inline-block;width:16px;margin-right:5px;"><div class="emptyprogressxbar" style="margin-top:5px;display:inline:block;">
                                            <div class="bravebarprogress" style="width:<?= $brperc ?>%;height: 5px;"></div>
                                        </div></div>
                                        <?php echo"<small>".cash_format($ir['brave'])."</small> / <b>".cash_format($ir['maxbrave']).""; ?></b>
                               </td>
                                 <td width="16%" class="tabstyle" align="left">
                                     <div class="iconbeside">
      <img src="https://topmafia.net/header/images/imageicons/health.png" style="display:inline-block;width:16px;margin-right:5px;"><div class="emptyprogressxbar" style="margin-top:5px;display:inline:block;">
                                            <div class="hpbarprogress" style="width:<?= $hpperc ?>%;height: 5px;"></div>
                                        </div></div>
                                        <?php echo"<small>".cash_format($ir['hp'])."</small> / <b>".cash_format($ir['maxhp']).""; ?></b>
                               </td>
                               
                            <td width="15%"  align="left"> <img src="https://topmafia.net/header/images/imageicons/money.png">  <a href="bank.php"><div class="cashmoney"><?php echo''.cash_format($ir['money']).'';?></div></a> 
                            <br />
                            <img src="https://topmafia.net/header/images/imageicons/ruby2.png" width="16px"> <a href="crystaltemple.php"><div class="crystaltext2"><?php echo''.cash_format($ir['crystals']).'';?></div></a>
                                ...
                                <td width="16%" style="padding:5px; font-family:Roboto;" align="center">
                        ...
                        <a href="criminal.php" class="usertopnavlink">Crimes</a> 
                        <a href="gym.php" class="usertopnavlink">Gym</a>
                        <a href="fight.php" class="usertopnavlink">Fight</a>
                        <div class="dropdown2">
...
echo'<footer id="footer">
        ...
        <small><img src="https://topmafia.net/header/images/imageicons/online.png">  <a href="usersonline.php">Online '.$onlinenow.'</a> &nbsp;&nbsp; <img src="https://topmafia.net/header/images/imageicons/offline.png">  <a href="userlist.php">Offline '.$registered.'</a></small><br />  <div class="legal">
            <span style="color:#999;">&copy; Copyright 2020 Top Mafia. All Rights Reserved.</span></div>
